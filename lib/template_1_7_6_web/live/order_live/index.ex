defmodule Template176Web.OrderLive.Index do
  use Template176Web, :live_view

  alias Template176.Orders
  alias Template176.Orders.Order
  ...
  @impl true
  def handle_info({Template176Web.OrderLive.FormComponent, {:saved, order}}, socket) do

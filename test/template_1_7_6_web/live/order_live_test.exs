defmodule Template176Web.OrderLiveTest do
  use Template176Web.ConnCase

  import Phoenix.LiveViewTest
  import Template176.OrdersFixtures

  @create_attrs %{user_uuid: "7488a646-e31f-11e4-aace-600308960662", total_price: "120.5"}
